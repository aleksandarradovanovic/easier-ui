      ...
      <div className="tabview-demo">
        ...
        <div className="card">
          ...
          <div className="pt-2 pb-4">
            <Button
              onClick={() => this.setState({ activeIndex1: 0 })}
              className="p-button-text mr-1"
              label="Activate 1st"
            />
            <Button
              onClick={() => this.setState({ activeIndex1: 1 })}
              className="p-button-text mr-1"
              label="Activate 2nd"
            />
            <Button
              onClick={() => this.setState({ activeIndex1: 2 })}
        ...
        <div className="card">
          ...
          <TabView>
            <TabPanel
              header="Header I"
              headerTemplate={this.tabHeaderITemplate}
            >
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
            ...
            <TabPanel
              headerTemplate={this.tabHeaderIITemplate}
            ...
            <TabPanel
              headerTemplate={this.tabHeaderIIITemplate}
              headerClassName="flex align-items-center"
            >
              <p>
                At vero eos et accusamus et iusto odio dignissimos ducimus qui
        ...
        <div className="card">
          ...
          <div className="py-2">
            <Button
              onClick={() => this.setState({ activeIndex2: 0 })}
              className="p-button-text mr-1"
              label="Activate 1st"
            />
            <Button
              onClick={() => this.setState({ activeIndex2: 29 })}
              className="p-button-text mr-1"
              label="Activate 30th"
            />
            <Button
              onClick={() => this.setState({ activeIndex2: 49 })}
              className="p-button-text"
              label="Activate 50th"
            />
          </div>
          ...
          <TabView
            ...
            onTabChange={(e) => this.setState({ activeIndex2: e.index })}
            scrollable
          >
