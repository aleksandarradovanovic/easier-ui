...
const ErrorModal = () => {
    ...
    return (
        <Dialog header={<Translate value={"label.error"} />} headerStyle={{ backgroundColor: "#e84343", color:"#fff" }} contentStyle={{padding:"2%"}} visible={showDialog} style={{ width: '50vw' }} footer={footer} onHide={() => onClose()}>
