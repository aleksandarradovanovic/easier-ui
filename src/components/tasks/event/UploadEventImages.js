...
export const UploadEventImages = () => {
    ...
    const onTemplateRemove = (element) => {
        ...
        if (element.name) {
            ...
            if (selectedImages && selectedImages.length > 0) {
                ...
                setUploadedImages(selectedImagesArray)
                dispatch(addToAppStore(applicationStore.SELECTED_EVENT_IMAGES, selectedImagesArray))
    ...
    const onTemplateUpload = (e) => {
        ...
        dispatch(addToAppStore(applicationStore.SELECTED_EVENT_IMAGES, uploadedImages))
